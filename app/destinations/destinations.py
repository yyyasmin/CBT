...
def get_public_dsts():
    ...
    for d in Destination.query.filter(Destination.hide==False).all():
        if public_scrt in d.children:
            all_public_dsts.append(d)
    return all_public_dsts
...
def show_dst_tree():
    ...
    print(" CALLING ./tree/dst_tree.html ")
    print("")
