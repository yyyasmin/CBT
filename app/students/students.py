...
def show_student_tree():
    ...
    for b in behaviors_new_nodes:
        print("behaviors_new_nodes-id", b)
        print("")
        
    for r in results_new_nodes:
        print("results_new_nodes-id", r)
        print("")
...
def set_gt_node(gt, parent_arr, user_node):
    ...
    print("IN set_gt_node parent_id", parent_id)
    print("")
