...
@gt.route('/remove_parent_from_gt<int:gt_id>/<int:parent_gt>', methods=['GET', 'POST'])
@login_required
def remove_parent_from_gt(gt_id, parent_gt):
...
@gt.route('/remove_parent_from_gt2/<int:gt_id>', methods=['GET', 'POST'])
@login_required
def remove_parent_from_gt2(gt_id):
